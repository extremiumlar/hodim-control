...
async def attendance_reminder_tick(
    ...
    """Ish oynasi boshlanishiga/tugashiga 10/5/0 daqiqa qolganda «Keldim»/«Ketdim»
    ...
    Bu endpoint Docker/scheduler rejimi va qo'lda `dry_run` tekshiruvi uchun
    saqlanadi."""
    from api.services.cron_jobs import attendance_reminder_tick as _tick
